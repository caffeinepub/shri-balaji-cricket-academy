...
export class Backend implements backendInterface {
    ...
    async getAllSubmissionsSortedByTimestamp(): Promise<Array<ContactSubmission>> {
    ...
    async submitContactForm(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: string): Promise<void> {
        if (this.processError) {
            try {
